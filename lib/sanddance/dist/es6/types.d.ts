...
import { Column, ColumnTypeMap, SpecCapabilities, SpecColorSettings, SpecLanguage, SpecViewOptions } from './specs/types';
...
export interface ViewerOptions extends SpecViewOptions {
     ...
     */
    lightSettings?: {
        [view in VegaDeckGl.types.View]: LightSettings;
    };
    /**
     * Lengths of time for a transition animation.
     */
