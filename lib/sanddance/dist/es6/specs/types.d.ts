 ...
 */
export declare type AxisSelectionType = 'exact' | 'range';
/**
 * Types of SandDance visualizations.
 */
export declare type Chart = 'barchart' | 'barchartH' | 'barchartV' | 'density' | 'grid' | 'scatterplot' | 'stacks' | 'treemap';
export declare type ColorBin = 'continuous' | 'quantize' | 'quantile';
/**
 * Column information.
 */
...
export declare type InsightColumnRoles = 'uid' | 'x' | 'y' | 'z' | 'group' | 'size' | 'color' | 'facet' | 'sort';
